...
//
//public class L_join백업 extends AppCompatActivity {
...
//
//                    //다이얼로그 "인증번호 재전송?"
//                    new AlertDialog.Builder(L_join백업.this) // 현재 Activity의 이름 입력.
...
//
//                Join Join_interface = retrofit.create(Join.class);   // 레트로핏 인터페이스 객체 구현
...
//                    L_join백업.this.runOnUiThread(new Runnable() { //쓰레드에서는 Toast를 띄우지 못하여 runOnUiThread를 호출해야 한다.
//                        @Override
//                        public void run() {
